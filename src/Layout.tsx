...
export default function Layout({ children, currentPageName }: LayoutProps) {
  ...
  const isDarkPage = (isAbout || isServicePage || ['Compliance', 'NewsEvents', 'SupportPortal', 'ContactUs', 'InquiryForm', 'CookiePolicy', 'PrivacyPolicy', 'PlaceholderPage'].includes(currentPageName)) && currentPageName !== 'BorderlessConnectivity' && currentPageName !== 'CloudServices' && currentPageName !== 'TIMCorpAI';
